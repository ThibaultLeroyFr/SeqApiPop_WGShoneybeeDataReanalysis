...
Then, the jointgenotyping was perfomed using GenotypeGVCFs (GATOK v.4.2.2.0) using the script script_lanceur_genotypegvcf_chrperchr.sh (see also script_genotypeGVCFsHAV3_1.sh) <br>
